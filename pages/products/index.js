        ...
        {products.length === 0 ? (
          ...
          <>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-md border-t border-b rounded-lg shadow-md">
                ...
                <tbody className="divide-y divide-gray-200">
                  {productsToDisplay.map((product, index) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-4 py-3 font-medium text-gray-900 flex items-center gap-3">
                      ...
                      <td className="whitespace-nowrap px-4 py-3 text-gray-700 truncate max-w-md">
                        {product.description}
                      </td>
                      ...
                      <td className="whitespace-nowrap px-4 py-3 gap-4 flex">
                        <Link
                          href={"/products/edit/" + product._id}
                          className="inline-block rounded-lg bg-green-500 px-4 py-2 text-xs font-medium text-white hover:bg-green-700 transition-colors"
                        >
                          Edit
                        </Link>
                        <Link
